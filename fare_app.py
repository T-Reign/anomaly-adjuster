...
SEQUENCES = {
    ...
    "Guildford-Hinchley Wood-via-Clandon": ["GUILDFORD", "LONDDON ROAD (GUILDFORD)", "CLANDON", "HORSLEY", "EFFINGHAM JUNCTION", "COBHAM & STOKE D'ABERNON", "OXSHOTT", "CLAYGATE", "HINCHLEY WOOD"],
...
if uploaded_files:
    ...
    st.dataframe(df[['Origin Description', 'Destination Description', 'Original_SDR', 'New_SDR', 'Status']], 
                 ...
                 use_container_width=True, hide_index=True)
    st.download_button("Sample Fares", df.to_csv(index=False), "Final_Quartz_Fares.csv")
